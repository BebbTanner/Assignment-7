...
function getTheTable() {
  ...
  function getAllParagraphs() {
    let nodeList = document.getElementById("myPage").querySelectorAll("p");
    return nodeList;
  }
  ...
  function makeItalic() {
    let nodeList = document.querySelectorAll("p.even");
  ...
  function createBorders() {
    let myTable = document.getElementById("myPage").querySelector("table");
  ...
  function getTheListItem(x, y) {
    let myItem = document.getElementById("myPage").querySelector(`ul:nth-of-type(${x}) li:nth-child(${y})`).textContent;
    return myItem;
  }
